...
import org.dominokit.craft.items.client.ui.variations.type.*;
...
public class VariationDialog extends ModalDialog {
    ...
    private Consumer<List<Variation>> handler;
    ...
    public VariationDialog setSaveHandler(Consumer<List<Variation>> handler) {
        this.handler = handler;
        return this;
    }

    public List<Variation> save() {
        return selectedVariationTypes.stream()
                .map(VariationType::getVariation)
